...
public class REDCapLogs
{
    ...
    public REDCapLogs()
    {
        ...
        params.add(new BasicNameValuePair("token", "F744175567DEF08D2BCC496B6E43D9E7"));
        ...
        params.add(new BasicNameValuePair("beginTime", "2025-10-01 12:41"));
        params.add(new BasicNameValuePair("endTime", "2025-10-21 09:10"));
        params.add(new BasicNameValuePair("format", "json"));
        params.add(new BasicNameValuePair("returnFormat", "json"));

        post = new HttpPost("https://redcaptest.ucc.ie/api/");
